...
def settings():
    people_images = os.listdir('/home/bernardo/workspace/sketches/militares/data/')
    generals_images = os.listdir(
        '/home/bernardo/workspace/sketches/militares/data/generais/')
    ...
    for filename in people_images:
        ...
        while not img:
            pass
        img.resize(IMG_HEIGHT, IMG_HEIGHT)
        img.filter(GRAY)
        people.append(img)
